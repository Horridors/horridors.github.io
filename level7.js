...
(() => {
  ...
  function drawPlayerSprite() {
    if (window.HorridorsSprites && window.HorridorsSprites.drawCharacter) {
      window.HorridorsSprites.drawChesterWalk(ctx, player.x + player.w/2, player.y + player.h + 8, (player.facing !== undefined ? (Math.cos(player.facing) >= 0 ? 1 : -1) : 1), 56);
      return;
    }
}
  ...
  function resumeLevel7() {
    ...
    ['overlay-l7-intro','overlay-l7-end','overlay-caught']
